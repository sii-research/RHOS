...
class NRUnetHybridImagePolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
            horizon, 
            n_action_steps, 
        ...
        print("NR params: %e" % sum(p.numel() for p in self.model.parameters()))
    ...
    def compute_loss(self, batch):
        ...
        pred_trajectory = self.model(noisy_trajectory, timesteps, 
            local_cond=local_cond, global_cond=global_cond)
