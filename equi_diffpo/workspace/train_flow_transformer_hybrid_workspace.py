...
from equi_diffpo.policy.flow_transformer_hybrid_image_policy import FlowTransformerHybridImagePolicy
...
class TrainFlowTransformerHybridWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: FlowTransformerHybridImagePolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: FlowTransformerHybridImagePolicy = None
